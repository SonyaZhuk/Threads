...
import concurrency.phaser.goods.Item;
import concurrency.phaser.goods.Storage;
...
public class Truck implements Runnable {
    ...
    private void loadTruck() {
        for (int i = 0; i < capacity; i++) {
            ...
            if (g == null) { // если в хранилище больше нет товара, загрузка грузовика прерывается
                return;
            }
            bodyStorage.add(g);
